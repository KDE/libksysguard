...
class ProcessObject : public QObject {
    ...
    public:
       ...
       Q_PROPERTY(qlonglong suid READ suid)                            PROPERTY_F(qlonglong, suid)
       Q_PROPERTY(qlonglong fsuid READ fsuid)                          PROPERTY_F(qlonglong, fsuid)
       Q_PROPERTY(qlonglong gid READ gid)                              PROPERTY_F(qlonglong, gid)
       Q_PROPERTY(qlonglong egid READ egid)                            PROPERTY_F(qlonglong, egid)
       Q_PROPERTY(qlonglong sgid READ sgid)                            PROPERTY_F(qlonglong, sgid)
       Q_PROPERTY(qlonglong tracerpid READ tracerpid)                  PROPERTY_F(qlonglong, tracerpid)
